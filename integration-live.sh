...
curl -f 'https://mimsa-api.isverymuchmybusiness.com/project/create'
...
curl -f -XPOST -H "Content-type: application/json" \
  ...
  'https://mimsa-api.isverymuchmybusiness.com/project/bind'
...
curl -f -XPOST -H "Content-type: application/json" -d '{ "feExprHash": "473b2818430785f170ccf76d36b2209eccd0c774604791cd110cd69bb0765437" }' 'https://mimsa-router.isverymuchmybusiness.com/fetch/expr'

# run api

echo -e "Call API expecting 200: OK\n"

curl 'https://mimsa-router.isverymuchmybusiness.com/1/healthz' | grep "OK" && echo -e "Success" || echo "Failure!"

echo -e "Call API expecting 500: Error\n"

curl 'https://mimsa-router.isverymuchmybusiness.com/1/other' | grep "Error" && echo -e "Success" || echo "Failure!"
