...
module Smol.Typecheck.Exhaustiveness
  ( isExhaustive,
    redundantCases,
    annihilate,
    validatePatterns,
...
validatePatterns ::
  ...
  [Pattern ResolvedDep (ResolvedType Annotation)] ->
  m ()
...
-- (gennedForA2, b)]
_generateMany ::
  NE.NonEmpty (Pattern ResolvedDep (ResolvedType Annotation)) ->
  m [NE.NonEmpty (Pattern ResolvedDep (ResolvedType Annotation))]
